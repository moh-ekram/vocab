...
export default function WordAnalogyGame({
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6" id="analogy-game-container">
      {/* Game Header */}
      <div className="bg-white p-5 rounded-2xl border border-slate-200/60 shadow-xs flex items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <h4 className="text-sm font-extrabold text-slate-800">Word Analogy Challenge</h4>
        </div>
      ...
      <div className="bg-slate-100 p-1 rounded-2xl border border-slate-200/55 flex gap-1 w-full" id="analogy-practice-filters">
        <button
